...
class BusTravel(models.Model):
    ...
    bus_station_departure_id = models.ForeignKey(
        BusStation, on_delete=models.CASCADE, related_name="bus_station_departure"
    )
    bus_station_arrival_id = models.ForeignKey(
        BusStation, on_delete=models.CASCADE, related_name="bus_station_arrival"
    )
